<?php
// source: C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/config/config.neon 
// source: C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/config/config.local.neon 

class Container_ab6bf59b76 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app',
			'wwwDir' => 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/../temp/cache',
	...
	{
		return new Container_ab6bf59b76_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife\app/../temp/cache/latte');
...
final class Container_ab6bf59b76_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_ab6bf59b76 $container)
	{
