...
class Container_b1059dfd8a extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\PostPresenter' => array(array('application.3')),
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=goldlife', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_b1059dfd8a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_b1059dfd8a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_b1059dfd8a $container)
	{
