<?php
// source: C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/config/config.neon 
// source: C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/config/config.local.neon 

class Container_acf02f84b8 extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\PostPresenter' => array(array('application.4')),
			'App\Presenters\SchedulePresenter' => array(array('application.5')),
		...
		'services' => array(
			...
			'application.5' => 'App\Presenters\SchedulePresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app',
			'wwwDir' => 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/../temp',
		));
	}
	...
	{
		$service = new App\Presenters\PostPresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=goldlife', 'root', '', array('lazy' => TRUE));
	...
	{
		return new Container_acf02f84b8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC9\goldlife.club\goldlife\app/../temp/cache/latte');
...
final class Container_acf02f84b8_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

	private $container;


	public function __construct(Container_acf02f84b8 $container)
	{
