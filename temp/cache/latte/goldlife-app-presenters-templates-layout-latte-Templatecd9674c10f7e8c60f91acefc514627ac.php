...
<head>
 ...
 | <?php } ?>SA GoldLife</title>
    ...
    <link rel="stylesheet" href="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/css/extras.css">
    <link rel="shortcut icon" class="glyphicon glyphicon-leaf">
...
">Activity</a></li>
                <li><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Camps:default"), ENT_COMPAT) ?>
">Camps</a></li>
